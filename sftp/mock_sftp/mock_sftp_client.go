...
// Source: github.com/khulnasoft/go-kit/sftp (interfaces: Client)
//
// Generated by this command:
//
//	mockgen -destination=mock_sftp/mock_sftp_client.go -package mock_sftp github.com/khulnasoft/go-kit/sftp Client
//
